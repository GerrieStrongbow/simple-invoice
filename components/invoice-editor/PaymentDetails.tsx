    ...
    <div className="bank-details rounded-2xl border border-slate-200 bg-slate-50 p-6">
      <h4 className="mb-5 flex items-center gap-2 text-lg font-bold text-slate-800">
        ...
        <input
          ...
          className="min-w-[180px] rounded-lg border-2 border-slate-200 bg-slate-100 px-3 py-1.5 text-base font-semibold text-slate-700 outline-hidden transition focus:border-indigo-400 focus:bg-white focus:ring-4 focus:ring-indigo-100"
        />
      </h4>
